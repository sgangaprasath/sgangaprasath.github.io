...
const e = [
    ...
    "tabIndex",
    "useMap"
].reduce((t, n)=>(t[n.toLowerCase()] = n, t), {
    for: "htmlFor"
}), o = {
    amp: "&",
    apos: "'",
...
function ht(t, n) {
    const e = 1 === n, r = e ? gt : yt, o = e ? dt : pt, c = e ? lt : st;
    return {
        t (t, n, e) {
            const o = rt.exec(e);
        ...
        i: Gt.HIGH,
        l (t, n, r) {
            const a = e ? +t[2] : void 0, _ = t[0].replace(u, "\n").match(o);
            let i = !1;
            return {
                p: _.map(function(t, e) {
                    const o = c.exec(t)[0].length, a = new RegExp("^ {1," + o + "}", "gm"), u = t.replace(a, "").replace(c, ""), l = e === _.length - 1, s = -1 !== u.indexOf("\n\n") || l && i;
                    i = s;
                    const f = r._, d = r.o;
                    let p;
...
function wt(t, n, e) {
    e._ = !0;
    const r = zt(t[1], n, e), o = t[2].replace(P, "").split("|").map(St), c = function(t, n, e) {
        return t.trim().split("\n").map(function(t) {
            return zt(t, n, e);
        });
    }(t[3], n, e);
...
function Ht(e, u = {}) {
    ...
    const P = u.createElement || react__WEBPACK_IMPORTED_MODULE_0__.createElement;
    function G(t, e, ...r) {
    ...
    function q(n) {
        ...
        return e ? e.reduce(function(n, e, o) {
            ...
            if (-1 !== c) {
                ...
                })(e.slice(0, c)).trim(), _ = function(t) {
                    const n = t[0];
                    return ('"' === n || "'" === n) && t.length >= 2 && t[t.length - 1] === n ? t.slice(1, -1) : t;
                }(e.slice(c + 1).trim()), u = r[a] || a, i = n[u] = function(t, n) {
                ...
                "string" == typeof i && (S.test(i) || E.test(i)) && (n[u] = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.cloneElement(H(i.trim()), {
                    key: o
                }));
    ...
    !0 !== u.disableParsingRawHTML && (et.htmlBlock = {
        ...
        i: Gt.HIGH,
        l (t, n, e) {
            const [, r] = t[3].match(tt), o = new RegExp(`^${r}`, "gm"), a = t[3].replace(o, ""), _ = (u = a, vt.some((t)=>t.test(u)) ? Ct : Tt);
            var u;
            const i = t[1].toLowerCase(), l = -1 !== c.indexOf(i);
            e.Z = e.Z || "a" === i;
    ...
    const rt = function(t) {
        ...
        if (Array.isArray(n)) {
            ...
            for(let r = 0; r < n.length; r++){
                e.k = r;
                const a = t(n[r], e), _ = "string" == typeof a;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((n)=>{
    let { children: r, options: o } = n, c = function(t, n) {
        if (null == t) return {};
        var e, r, o = {}, c = Object.keys(t);
        for(r = 0; r < c.length; r++)n.indexOf(e = c[r]) >= 0 || (o[e] = t[e]);
        return o;
    }(n, e);
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.cloneElement(Ht(r, o), c);
});
