...
In this 4 part series we will be discussing problems each with a certain unique aspect in terms of implementation in `auto-07p` associated with the type of problem. It will become clear what I mean by this as we go over the examples.
